...
const BANNER_DATA = {
  title: 'Next level product management solutions for Crypto companies',
  text:
    'We help top performing crypto companies shape their product and understand their users with competitive benchmarking.',
  button: {
    link: '#',
    label: 'Learn more',
  },
