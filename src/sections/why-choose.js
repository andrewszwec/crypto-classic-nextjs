...
const WHY_CHOOSE_DATA = {
  blockTitle: {
    title: 'Why choose Fusion Labs',
    text: 'We offer premium service to the market\'s top companies.',
  },
  posts: [
    {
      icon: icon1,
      title: 'Great Value',
      text:
        'Create successful products with an experienced partner.',
    },
    {
      icon: icon2,
      title: 'Award winning design',
      text:
        'Designs that will make users want to keep coming back.',
    },
    {
      icon: icon3,
      title: 'High quality delivery',
      text:
        'Delivered by a world class team.',
    },
    {
      icon: icon4,
      title: 'Secure Transactions',
      text:
        'Secure transactions using crypto native payment methods.',
    },
  ],
};
